      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-8 py-12">
        <div className="text-center max-w-2xl mx-auto w-full">
          ...
          <p className="text-base leading-relaxed text-white/70 mb-8 max-w-xl mx-auto">
            Authenticate with your Google account to access the ultimate cybersecurity challenges.
          </p>

          {/* Error Message */}
          {error && (
            <div className="mb-6 p-4 bg-red-500/20 border border-red-500/30 rounded-lg text-red-400 text-sm max-w-lg mx-auto">
          ...
          <div className="max-w-lg mx-auto">
            <GoogleLogin
              className="w-full px-6 py-3 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 hover:border-white/40 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 group"
